...
- `agent-vault vault credential set --vault <project> KEY=value` — для <project> (Jira, Confluence)
- `agent-vault vault credential set --vault <project> KEY=value` — для <project>
